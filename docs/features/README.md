...
**The result:** ~70% of messages never hit OpenAI. The whole chatbot costs roughly **3 cents per month** at normal traffic. And common questions are answered _faster_ because there's no API round-trip.
