...
const IMAGES = [whaleImg, limonImg, haitisesImg, rinconImg, snorkelImg, atvImg, ziplineImg, kiteImg]
  ...
  return (
    <main className="excursions-page">
      ...
      <header className="excursions-header">
        ...
        <h1 className="excursions-title">{t('excursions.title')} <span className="excursions-title-gold">{t('excursions.titleGold')}</span></h1>
        ...
        {excursions.map((excursion, i) => (
          <li className="excursion-entry" key={i}>
            ...
            <div className="excursion-entry-meta">
              <span className="excursion-entry-id">{String(i + 1).padStart(2, '0')}</span>
              <span className="excursion-entry-duration">{excursion.duration}</span>
            ...
            <div className="excursion-entry-body">
              <div className="excursion-image-wrap">
                {IMAGES[i]
                  ? <img src={IMAGES[i]} alt={excursion.name} className="excursion-image" />
                  : <div className="excursion-image-placeholder">
                      <span className="excursion-image-placeholder-name">{excursion.name}</span>
                    </div>
                }
              </div>
