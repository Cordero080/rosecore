/**
 * UI Icons
 * Settings, visibility, menus, grid, clock
 */
...
/** Eye off - used for Hide/Visibility toggle */
...
/** More options (3 dots) - used for Menu */
export const MoreIcon = ({ size = 18, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Horizontal dots for more options */
export const MoreHorizontalIcon = ({ size = 18, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Circle outline for public/privacy */
