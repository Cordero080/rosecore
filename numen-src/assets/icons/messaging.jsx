...
/** Emoji/Smile face */
export const EmojiIcon = ({ size = 20, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Thought bubble icon (variant) */
export const ThoughtBubbleIcon = ({ size = 16, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
