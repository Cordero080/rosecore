/**
 * User & Profile Icons
 * User avatars, privacy, profile frames
 */

/** User silhouette - used for avatars */
...
/** Globe - used for Public visibility */
...
/** Lock - used for Private visibility */
export const LockIcon = ({ size = 20, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Friends/People - used for Friends-only visibility */
export const FriendsIcon = ({ size = 20, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Add Friend - user with plus sign */
export const AddFriendIcon = ({ size = 20, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Hexagon avatar frame for profile */
export const HexProfileIcon = ({ size = 24, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
